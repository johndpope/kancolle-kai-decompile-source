...
namespace KCV.Production
{
	public class ProdBattleReceiveShip : BaseReceiveShip
	{
		...
		protected override void init()
		{
			...
			this._uiParStar1.SetActive(false);
			this._uiParStar2.SetActive(false);
			this.timer = 0;
		...
		{
			return ProdBattleReceiveShip.Instantiate(prefab, parent, rewardShip, nPanelDepth, input, true);
		}
		...
		private void compStartAnimation()
		{
			if (this._isNeedBGM)
			{
				this._uiParStar1.SetActive(true);
				this._uiParStar1.Play();
				this._uiParStar2.SetActive(true);
		...
		private void FadeOutExtinguish()
		{
			...
			this._uiParStar1.Stop();
			this._uiParStar1.SetActive(false);
			this._uiParStar2.Stop();
			this._uiParStar2.SetActive(false);
