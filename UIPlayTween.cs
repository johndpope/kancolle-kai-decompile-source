...
public class UIPlayTween : MonoBehaviour
{
	...
	private void Start()
	{
		...
		{
			this.tweenTarget = base.get_gameObject();
		}
	}
	...
	{
		if (base.get_enabled() && (this.trigger == Trigger.OnHover || (this.trigger == Trigger.OnHoverTrue && isOver) || (this.trigger == Trigger.OnHoverFalse && !isOver)))
		{
	...
	{
		if (base.get_enabled() && this.mActivated)
		{
	...
	{
		if (base.get_enabled() && (this.trigger == Trigger.OnPress || (this.trigger == Trigger.OnPressTrue && isPressed) || (this.trigger == Trigger.OnPressFalse && !isPressed)))
		{
	...
	{
		if (base.get_enabled() && this.trigger == Trigger.OnClick)
		{
			this.Play(true);
		}
	}
	...
	{
		if (base.get_enabled() && this.trigger == Trigger.OnDoubleClick)
		{
			this.Play(true);
		}
	}
	...
	{
		if (base.get_enabled() && (this.trigger == Trigger.OnSelect || (this.trigger == Trigger.OnSelectTrue && isSelected) || (this.trigger == Trigger.OnSelectFalse && !isSelected)))
		{
	...
	{
		if (!base.get_enabled() || UIToggle.current == null)
		{
			return;
		}
