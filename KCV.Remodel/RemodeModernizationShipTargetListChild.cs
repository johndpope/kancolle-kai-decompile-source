...
namespace KCV.Remodel
{
	public class RemodeModernizationShipTargetListChild
	{
		...
		public RemodeModernizationShipTargetListChild.ListItemOption mOption
		{
			get;
			private set;
		}
		...
		public RemodeModernizationShipTargetListChild(RemodeModernizationShipTargetListChild.ListItemOption option, ShipModel model)
		{
			this.mOption = option;
