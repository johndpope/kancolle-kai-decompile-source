...
public class UIImageButton : MonoBehaviour
{
	...
	public bool isEnabled
	{
		get
		{
			...
			return component && component.get_enabled();
		}
		set
		{
			Collider component = base.get_gameObject().GetComponent<Collider>();
			...
			if (component.get_enabled() != value)
			{
	...
	private void UpdateImage()
	{
		if (this.target != null)
		{
			if (this.isEnabled)
			{
				this.SetSprite((!UICamera.IsHighlighted(base.get_gameObject())) ? this.normalSprite : this.hoverSprite);
			}
			else
			{
