...
public class PropertyReference
{
	...
	public Type GetPropertyType()
	{
		...
		{
			return this.mProperty.get_PropertyType();
		}
		if (this.mField != null)
		{
			return this.mField.get_FieldType();
		}
		return typeof(void);
	}
	...
	public bool Set(object value)
	{
		...
		if (value == null)
		{
			try
			{
				...
				if (this.mProperty.get_CanWrite())
				{
