...
public class UILabel : UIWidget
{
	...
	public override Material material
	{
		get
		{
			...
			{
				return this.mTrueTypeFont.get_material();
			}
			return null;
		}
		set
	...
	public int textInt
	{
		...
		{
			int result;
			int.TryParse(this.mText, ref result);
			return result;
		}
		set
		{
			if (this.mText != value.ToString())
			{
	...
	protected void SetActiveFont(Font fnt)
	{
		...
		{
			int num;
			if (this.mActiveTTF != null && UILabel.mFontUsage.TryGetValue(this.mActiveTTF, ref num))
			{
				num = Mathf.Max(0, --num);
				if (num == 0)
				{
				...
				{
					UILabel.mFontUsage.set_Item(this.mActiveTTF, num);
				}
			}
			this.mActiveTTF = fnt;
			if (this.mActiveTTF != null)
			{
				int num2 = 0;
				UILabel.mFontUsage.set_Item(this.mActiveTTF, num2 + 1);
			}
		}
	}
	...
	protected override void OnEnable()
	{
		...
		if (!UILabel.mTexRebuildAdded)
		{
			...
			Font.add_textureRebuilt(new Action<Font>(UILabel.OnFontChanged));
		}
	}
	...
	protected override void OnStart()
	{
		...
		this.mPremultiply = (this.material != null && this.material.get_shader() != null && this.material.get_shader().get_name().Contains("Premultiplied"));
		this.ProcessAndRequest();
	}
