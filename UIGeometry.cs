...
public class UIGeometry
{
	...
	public void ApplyTransform(Matrix4x4 widgetToPanel)
	{
		if (this.verts.size > 0)
		{
			...
			this.mRtpNormal = widgetToPanel.MultiplyVector(Vector3.get_back()).get_normalized();
			Vector3 normalized = widgetToPanel.MultiplyVector(Vector3.get_right()).get_normalized();
