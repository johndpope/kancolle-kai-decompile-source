...
public class BMFont
{
	...
	public bool isValid
	{
		get
		{
			return this.mSaved.get_Count() > 0;
		}
	}
	...
	public int glyphCount
	{
		get
		{
			return (!this.isValid) ? 0 : this.mSaved.get_Count();
		}
	}
	...
	public BMGlyph GetGlyph(int index, bool createIfMissing)
	{
		...
		if (this.mDict.get_Count() == 0)
		{
			int i = 0;
			int count = this.mSaved.get_Count();
			while (i < count)
			{
				BMGlyph bMGlyph2 = this.mSaved.get_Item(i);
	...
	public void Trim(int xMin, int yMin, int xMax, int yMax)
	{
		if (this.isValid)
		{
			...
			while (i < count)
			{
				BMGlyph bMGlyph = this.mSaved.get_Item(i);
				if (bMGlyph != null)
				{
