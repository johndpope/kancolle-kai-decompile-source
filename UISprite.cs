...
public class UISprite : UIBasicSprite
{
	...
	public UIAtlas atlas
	{
		...
		set
		{
			if (this.mAtlas != value)
			{
				...
				this.mSprite = null;
				if (string.IsNullOrEmpty(this.mSpriteName) && this.mAtlas != null && this.mAtlas.spriteList.get_Count() > 0)
				{
					this.SetAtlasSprite(this.mAtlas.spriteList.get_Item(0));
	...
	public override Vector4 drawingDimensions
	{
		get
		{
			...
			Vector4 vector = (!(this.mAtlas != null)) ? Vector4.get_zero() : (this.border * this.pixelSize);
	...
	public UISpriteData GetAtlasSprite()
	{
		...
		if (this.mSprite == null && this.mAtlas != null)
		{
			...
			if (this.mSprite == null && this.mAtlas.spriteList.get_Count() > 0)
			{
				UISpriteData uISpriteData = this.mAtlas.spriteList.get_Item(0);
				...
				{
					Debug.LogError(this.mAtlas.get_name() + " seems to have a null sprite!");
					return null;
				}
				this.mSpriteName = this.mSprite.name;
			}
	...
	public override void OnFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
	{
		...
		rect = NGUIMath.ConvertToTexCoords(rect, mainTexture.get_width(), mainTexture.get_height());
		rect2 = NGUIMath.ConvertToTexCoords(rect2, mainTexture.get_width(), mainTexture.get_height());
		int size = verts.size;
